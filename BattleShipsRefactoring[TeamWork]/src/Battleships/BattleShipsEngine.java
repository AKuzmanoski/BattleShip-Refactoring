...
public class BattleShipsEngine {
	...
	public static void main(String args[]) {
		...
		System.out.println("PlayerTurn "
				+ gui.data.getGameState().isPlayerTurn());
		System.out.println("Deployed "
				+ gui.data.getGameState().isBothPlayerAndAgentShipsDeployed());
		System.out.println("PlayerTurn "
				+ gui.data.getGameState().isPlayerTurn());
		System.out.println("Deployed "
				+ gui.data.getGameState().isBothPlayerAndAgentShipsDeployed());
		...
		while (!gui.getGameOver()) {
			...
			while (gui.data.getGameState().isAgentTurn()
					&& !gui.data.getGameState().IsGameOver()) {
				...
				System.out.println("shot at " + smith.getI() + " "
						+ smith.getJ());
				System.out.println(gui.data.getGameState().getCompAtt()
						.toString());
	...
	public void setDataPanels(GUI gui) {
		...
		homePanel.addMouseListener(new HomeMousePressListener(homePanel, gui));
